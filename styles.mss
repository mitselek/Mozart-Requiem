...
<museScore version="3.02">
  <Style>
    ...
    <pagePrintableWidth>7.2126</pagePrintableWidth>
    ...
    <akkoladeDistance>8</akkoladeDistance>
    ...
    <minSystemSpread>10.5</minSystemSpread>
    ...
    <lyricsOddFontSize>14</lyricsOddFontSize>
    ...
    <lyricsOddFramePadding>0.4</lyricsOddFramePadding>
    <lyricsOddFrameWidth>0.2</lyricsOddFrameWidth>
    ...
    <dividerRightSym>systemDividerExtraLong</dividerRightSym>
    ...
    <articulationAnchorDefault>3</articulationAnchorDefault>
    ...
    <smallNoteMag>1.05</smallNoteMag>
    ...
    <dynamicsFontSize>15</dynamicsFontSize>
    ...
    <translatorFontSpatiumDependent>1</translatorFontSpatiumDependent>
    <translatorFontStyle>1</translatorFontStyle>
    <translatorColor r="0" g="0" b="0" a="255"/>
    <translatorAlign>center,baseline</translatorAlign>
    <translatorOffset x="0" y="0"/>
    <translatorFrameType>1</translatorFrameType>
    <translatorFramePadding>0.5</translatorFramePadding>
    <translatorFrameWidth>0.2</translatorFrameWidth>
    ...
    <rehearsalMarkFramePadding>0.9</rehearsalMarkFramePadding>
    ...
    <user1Name>Page Number Odd</user1Name>
    <user1FontFace>Times New Roman</user1FontFace>
    <user1FontSize>15</user1FontSize>
    <user1LineSpacing>1</user1LineSpacing>
    <user1FontSpatiumDependent>0</user1FontSpatiumDependent>
    <user1FontStyle>1</user1FontStyle>
    <user1Color r="0" g="0" b="0" a="255"/>
    <user1Align>left,baseline</user1Align>
    <user1Offset x="0" y="0"/>
    ...
    <user2Name>Page Number Even</user2Name>
    <user2FontFace>Times New Roman</user2FontFace>
    <user2FontSize>15</user2FontSize>
    <user2LineSpacing>1</user2LineSpacing>
    <user2FontSpatiumDependent>0</user2FontSpatiumDependent>
    <user2FontStyle>1</user2FontStyle>
    <user2Color r="0" g="0" b="0" a="255"/>
    <user2Align>left,baseline</user2Align>
    <user2Offset x="0" y="0"/>
    ...
    <user6Align>right,baseline</user6Align>
    <user6Offset x="0" y="0"/>
    <user6OffsetType>1</user6OffsetType>
    <user6FrameType>0</user6FrameType>
    <user6FramePadding>0</user6FramePadding>
    <user6FrameWidth>0</user6FrameWidth>
